...
export async function handleHelper(
    ...
    let builder: string[] = [
        ...
        ``,
        `\`dokyu!list\``,
        `- Affiche les listes d'attente qui tournent sur ce serveur, pour que vous puissiez les rejoindre.`,
        `- S'envoie sur un serveur.`,
        ``,
        `\`dokyu!leave\``,
        `- Vous retire d'une liste d'attente si vous avez fait une erreur ou êtes revenus sur votre décision.`,
        `- S'envoie n'importe où.`,
        ``,
        `\`dokyu!create\` suivi d'un dodo code`,
        `- Permet de créer une nouvelle file d'attente.`,
        `- S'envoie dans les MPs du bot.`,
        `- exemple: \`dokyu!create 1234A5\`.`,
        ``,
        `\`dokyu!publish\``,
        `- Publie et lance une file d'attente sur un serveur.`,
        `- Elle doit avoir été créée préalablement dans les MPs du bot avec \`dokyu!create\`.`,
        `- S'envoie sur un serveur.`,
        ``,
        `\`dokyu!force\``,
        `- Permet de forcer le passage à la personne suivante.`,
        `- Se lance par le créateur d'une liste.`,
        `- S'envoie n'importe où.`,
        ``,
        `\`dokyu!close\``,
        `- Arrête les listes d'attente que vous avez créé.`,
        `- S'envoie n'importe où.`,
        // ``,
        // ``,
        // ``,
