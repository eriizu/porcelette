...
export async function helper(msg: discord.Message | discord.PartialMessage, _splitMsg: string[]) {
    ...
    message.addFields([
        ...
        { name: "\u200B", value: "\u200B" },
        {
            ...
            value:
                '`navet!getzones <code pays ISO à deux lettres>`\nAffiche les fuseaux horaires qui existent pour votre pays.\nLe code de la France est : "fr"\n\n`navet!setzone <nom du fuseau>`\nM\'indique le fuseau horaire dans lequel votre île est située. Le nom du fuseau à donner doit être tel que renvoyé par la commande `getzones`.',
        },
    ]);
